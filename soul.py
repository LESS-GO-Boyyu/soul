...
TOKEN = '6773739212:AAF7qp3f1LkJT2QhKhYaHa1X2EJZU3P8Px8'
MONGO_URI = 'mongodb+srv://admin:kpR4ObsewTySq48I@test.zeqrmgb.mongodb.net/test_db?retryWrites=true&w=majority'
CHANNEL_ID = -1001878293417
ADMIN_IDS = [5371025901, 808697013, 2345678901, 3456789012, 4567890123]
...
def attack_command(message):
    ...
    bot.send_message(message.chat.id, "*𝐏𝐥𝐞𝐚𝐬𝐞 𝐄𝐧𝐭𝐞𝐫 𝐭𝐡𝐞 𝐓𝐚𝐫𝐠𝐞𝐭 𝐈𝐩 𝐀𝐧𝐝 𝐏𝐨𝐫𝐭🛫*", parse_mode='Markdown')
